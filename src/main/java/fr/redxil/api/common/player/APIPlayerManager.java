...
public interface APIPlayerManager {
     ...
     */
    Optional<APIPlayer> getPlayer(long id);
     ...
     */
    Optional<APIOfflinePlayer> getOfflinePlayer(String name);
     ...
     * @return APIPlayerOffline or null if the player never connected on the server
     */
    Optional<APIOfflinePlayer> getOfflinePlayer(long memberID);
     ...
     * @return APIPlayerOffline or null if the player never connected on the server
     */
    Optional<APIOfflinePlayer> getOfflinePlayer(UUID uuid);

    Optional<APIPlayer> loadPlayer(String pseudo, UUID uuid, IpInfo ipInfo);
     ...
     */
    Optional<LinkData> getLink(int linkID);
